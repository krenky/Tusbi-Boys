...
namespace Back_v._2.Migrations.Shopdb
{
    ...
    [Migration("20211204130514_AddWishList")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AspNetUserProduct", b =>
                {
                    b.Property<string>("AspNetUsersWishListId")
                        .HasColumnType("text");

                    b.Property<int>("WishListId")
                        .HasColumnType("integer");

                    b.HasKey("AspNetUsersWishListId", "WishListId");

                    b.HasIndex("WishListId");

                    b.ToTable("AspNetUserProduct");
                });
            ...
            modelBuilder.Entity("AspNetUserProduct", b =>
                {
                    b.HasOne("Back_v._2.Models.AspNetUser", null)
                        .WithMany()
                        .HasForeignKey("AspNetUsersWishListId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Back_v._2.Models.Product", null)
                        .WithMany()
